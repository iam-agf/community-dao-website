...
export let description = {
    ...
    "nick": "My name is Welding. I've been in crypto for 3-4 years. I found cosmos in 2021; It all started with IBC tokens like Osmosis, ever since then, I've been in love with the cosmos ecosystem... Then this little Useless token came along called HUAHUA, I've been in love with HUAHUA ever since. I'm the co-lead of the chihuahua community DAO. Avid supporter of COSMOS. Our goal is to be on chains we believe we can supply value too. We highly appreciate your contribution to the growth of our goals.",
    ...
    "jorin": "Here Jorin. I discovered the whole cosmos in March of this year (2022) and never turn back on other ecosystems. You can find me in several chats treating bad people who are rude, but if you need help you can always reach me at telegram, discord or twitter, with the same tag ( cosmo_jorin ). Not much to tell about me, except that I'm good at Math (not meth, psycho) and coding trinkets.",
}
